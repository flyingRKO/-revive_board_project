...
public class MemberCreateForm {
    ...
    @Pattern(regexp = "[a-zA-Z0-9]{8,15}", message = "비밀번호 확인은 필수항목입니다, 비밀번호 확인은 영어와 숫자로 포함해서 8~15자리 이내로 입력해주세요.")
    ...
    @Size(min = 10, max = 11, message = "휴대폰 번호는 10-11자리 숫자만 입력해주세요.")
    @Digits(integer = 11, fraction = 0, message = "휴대폰 번호는 숫자만 입력해주세요.")
